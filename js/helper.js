...
var HTMLwelcomeMsg = '<span class="summary-message">%data%</span><hr/>';

var HTMLskills = '<div id="%id%" class="skill-bar" data-perc="%percent%" title="%heading%"><span>%title%</span>';
var HTMLskillBar = '<div class="bar skill-bar-color percent"><span>%percent%%</span></div></div>';
